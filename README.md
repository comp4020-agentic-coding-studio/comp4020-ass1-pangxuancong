...
pnpm preview    # serve dist/ under the Pages base path, then in another shell:
pnpm dlx linkinator http://localhost:4321/<repo>/ --recurse --silent   # reproduce CI's links check
```
